...
#include "../../puerta_corrediza/inc/sc_types.h"
#include "../../puerta_corrediza/inc/main.h"
#include "../../puerta_corrediza/inc/TimerTicks.h"
#include "../../puerta_corrediza/gen/Model.h"
