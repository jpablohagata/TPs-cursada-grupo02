...
#include "../../panel_de_control/inc/sc_types.h"
#include "../../panel_de_control/inc/main.h"
#include "../../panel_de_control/inc/TimerTicks.h"
#include "../../panel_de_control/gen/Model.h"
